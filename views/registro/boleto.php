<main class="pagina">
    ...
    <p class="pagina__descripcion">Tu Boleto - Te reocomendamos almacenarlo, puede compartirlo en redes sociales</p>
    ...
    <div class="boleto-virtual">
        <div class="boleto boleto--<?php echo strtolower($registro->paquete->nombre); ?> boleto--acceso">
            <div class="boleto__contenido">
                ...
                <p class="boleto__nombre"><?php echo $registro->usuario->nombre . ' ' . $registro->usuario->apllido; ?></p>
            </div>
