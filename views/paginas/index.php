...
<section class="resumen">
    <div class="resumen__grid">
        <div class="resumen__bloque" data-aos="fade-right">
            <p class="resumen__texto--numero"><?php echo $total['ponentes']; ?></p>
            <p class="resumen__texto">Speakers</p>
        </div>
        <div class="resumen__bloque" data-aos="fade-left">
            <p class="resumen__texto--numero"><?php echo $total['conferencias']; ?></p>
            <p class="resumen__texto">Conferencias</p>
        </div>
        <div class="resumen__bloque" data-aos="fade-right">
            <p class="resumen__texto--numero"><?php echo $total['workshops']; ?></p>
    ...
    <div class="speakers__grid">
        <?php foreach ($ponentes as $ponente) : ?>
            <div class="speaker" <?php aos_animacion(); ?>>
                <picture>
                    <source srcset="build/img/speakers/<?php echo $ponente->imagen; ?>.webp" type="image/webp">
                    <source srcset="build/img/speakers/<?php echo $ponente->imagen; ?>.png" type="image/png">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="build/img/speakers/<?php echo $ponente->imagen; ?>.png" alt="ImagenPonente">
                </picture>
